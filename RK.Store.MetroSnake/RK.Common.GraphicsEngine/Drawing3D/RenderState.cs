...
namespace RK.Common.GraphicsEngine.Drawing3D
{
    public class RenderState : IDisposable
    {
        ...
        {
            Reset(renderTargetView, depthStencilView, viewport, viewProj);
        }
        ...
        public RenderState(
            ...
            : this(device, deviceContext)
        {
            Reset(renderTargetViews, depthStencilView, viewports, viewProj);
        }
        ...
        public void ApplyMaterial(MaterialResource resourceToApply)
        {
            ...
            if (m_lastAppliedResource != resourceToApply)
            {
                m_lastAppliedResource = resourceToApply;
                resourceToApply.Apply(this, MaterialApplyMode.Full);
            }
            else
            {
                resourceToApply.Apply(this, MaterialApplyMode.OnlyForNewObject);
            }
        }
