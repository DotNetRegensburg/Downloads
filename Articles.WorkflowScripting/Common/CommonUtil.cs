...
namespace Common
{
    public static class CommonUtil
    {
        ...
        /// <summary>
        /// Registers the assembly resolve event on current AppDomain.
        /// </summary>
        public static void RegisterAssemblyResolveEvent()
        {
            if (!s_assemblyResolveRegistered)
            {
                //Searches for an assembly with the same name
                AppDomain.CurrentDomain.AssemblyResolve += (sender, eArgs) =>
                {
                    ...
                    {
                        if (actAssembly.FullName == eArgs.Name) { return actAssembly; }
                    }
                    return null;
                };
                s_assemblyResolveRegistered = true;
            }
        }
        ...
        /// </summary>
        public static void LoadAssembly(byte[] assemblyRawData)
        {
            AppDomain.CurrentDomain.Load(assemblyRawData);
        }

        /// <summary>
        /// Loads the given assembly.
        /// </summary>
        public static void LoadAssembly(byte[] assemblyRawData, byte[] symbolData)
        {
            AppDomain.CurrentDomain.Load(assemblyRawData, symbolData);
        }
        ...
        /// <summary>
        /// Gets an IWin32Window object targeting the given wpf window.
        /// </summary>
        /// <param name="wpfWindow">The wpf window to create the IWin32Window object for.</param>
        public static WinForms.IWin32Window GetWpfWindowHandle(Window wpfWindow)
        {
            WindowInteropHelper interopHelper = new WindowInteropHelper(wpfWindow);
            return new InteropWindowWrapper(interopHelper);
        }

        /// <summary>
        /// Sends shutdown call tho this machine.
        /// </summary>
        public static void ShutdownThisMachine()
        {
        ...
        /// <summary>
        /// Gets the common application path for the application name provided by the first assembly of this domain.
        /// </summary>
        ...
        /// <summary>
        /// Gets the common application path for the given application name.
        /// </summary>
        ...
        /// <summary>
        /// Gets the common application path for the current user and the application name provided by the first assembly of this domain.
        /// </summary>
        ...
        /// <summary>
        /// Gets the common application path for the current user and the given application name.
        /// </summary>
        /// <param name="applicationName">Name of the application.</param>
