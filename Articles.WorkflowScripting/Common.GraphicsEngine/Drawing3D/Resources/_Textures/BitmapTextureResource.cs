...
namespace Common.GraphicsEngine.Drawing3D.Resources
{
    public class BitmapTextureResource : TextureResource
    {
        ...
        //Events
        public event LoadTextureEventHandler LoadingTexture;
        ...
        protected override void LoadResourceInternal(ResourceDictionary resources)
        {
            if (m_texture == null)
            {
                ...
                //Get source bitmap
                Bitmap bitmap = RaiseLoadingTexture();
                if (bitmap == null) { bitmap = m_bitmap; }
                ...
                else if (!string.IsNullOrEmpty(m_sourceFile))
                {
                    ...
                    m_texture = D3D11.Texture2D.FromFile(device, m_sourceFile, new D3D11.ImageLoadInformation()
                    {
                        ...
                        FilterFlags = D3D11.FilterFlags.None,
        ...
        /// <summary>
        /// Raises the LoadingTexture event.
        /// </summary>
        private Bitmap RaiseLoadingTexture()
        {
            if(LoadingTexture != null)
            {
                LoadTextureEventArgs eArgs = new LoadTextureEventArgs();
                LoadingTexture(this, eArgs);
                return eArgs.Source;
            }
            return null;
        }
