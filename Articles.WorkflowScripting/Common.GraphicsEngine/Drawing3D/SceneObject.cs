...
namespace Common.GraphicsEngine.Drawing3D
{
    public abstract class SceneObject
    {
        ...
        //public bool ContainedInVisibilityLayers(List<string> visibilityLayers)
        //{
        //    return true;
        //}
        ...
        public void Update(UpdateState updateState)
        {
            ...
            //int animationCount = m_animations.Count;
            //for (int loop = 0; loop < animationCount; loop++)
            //{
            //    ObjectAnimation actAnimation = m_animations[loop];
            //    actAnimation.Update(updateState);
            //}
