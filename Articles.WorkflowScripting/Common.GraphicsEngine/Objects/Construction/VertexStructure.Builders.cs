...
namespace Common.GraphicsEngine.Objects.Construction
{
    public partial class VertexStructure
    {
        ...
        public void BuildConeFullV(Vector3 bottomMiddle, float radius, float height, int countOfSegments, Color4 color)
        {
            ...
            short bottomVertexIndex = AddVertex(bottomVertex);
        ...
        public void BuildCylinderFullV(Vector3 bottomMiddle, float radius, float height, int countOfSegments, Color4 color)
        {
            ...
            //Add bottom and top vertices to the structure
            short bottomVertexIndex = AddVertex(bottomVertex);
            short topVertexIndex = AddVertex(topVertex);
        ...
        /// </summary>
        public void BuildShpere(int tDiv, int pDiv, double radius)
        {
        ...
        public void BuildCube8V(Vector3 start, Vector3 size, Color4 color)
        {
            ...
            short a = this.AddVertex(vertex);
            short b = this.AddVertex(vertex.Copy(new Vector3(dest.X, start.Y, start.Z)));
            short c = this.AddVertex(vertex.Copy(new Vector3(dest.X, start.Y, dest.Z)));
            short d = this.AddVertex(vertex.Copy(new Vector3(start.X, start.Y, dest.Z)));
            short e = this.AddVertex(vertex.Copy(new Vector3(start.X, dest.Y, start.Z)));
            short f = this.AddVertex(vertex.Copy(new Vector3(dest.X, dest.Y, start.Z)));
            short g = this.AddVertex(vertex.Copy(new Vector3(dest.X, dest.Y, dest.Z)));
            short h = this.AddVertex(vertex.Copy(new Vector3(start.X, dest.Y, dest.Z)));
        ...
        public void BuildCubeSides16V(Vector3 start, Vector3 size, Color4 color)
        {
            ...
            short a = this.AddVertex(vertex);
            short b = this.AddVertex(vertex.Copy(new Vector3(dest.X, start.Y, start.Z), new Vector2(texX, texY)));
            short c = this.AddVertex(vertex.Copy(new Vector3(dest.X, dest.Y, start.Z), new Vector2(texX, 0f)));
            short d = this.AddVertex(vertex.Copy(new Vector3(start.X, dest.Y, start.Z), new Vector2(0f, 0f)));
        ...
        public void BuildRect4V(Vector3 pointA, Vector3 pointB, Vector3 pointC, Vector3 pointD, Color4 color)
        {
            ...
            short a = this.AddVertex(vertex);
            short b = this.AddVertex(vertex.Copy(pointB, new Vector2(texX, texY)));
            short c = this.AddVertex(vertex.Copy(pointC, new Vector2(texX, 0f)));
            short d = this.AddVertex(vertex.Copy(pointD, new Vector2(0f, 0f)));
        ...
        public void BuildRect4V(Vector3 pointA, Vector3 pointB, Vector3 pointC, Vector3 pointD, Vector3 normal, Color4 color, Vector2 minTexCoord, Vector2 maxTexCoord)
        {
            ...
            short a = this.AddVertex(vertex);
            short b = this.AddVertex(vertex.Copy(pointB, new Vector2(maxTexCoord.X, maxTexCoord.Y)));
            short c = this.AddVertex(vertex.Copy(pointC, new Vector2(maxTexCoord.X, minTexCoord.Y)));
            short d = this.AddVertex(vertex.Copy(pointD, new Vector2(minTexCoord.X, minTexCoord.Y)));
