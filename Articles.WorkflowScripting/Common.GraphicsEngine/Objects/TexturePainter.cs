...
namespace Common.GraphicsEngine.Objects
{
    public class TexturePainter : SceneObject
    {
        ...
        /// Initializes a new instance of the <see cref="TexturePainter"/> class.
        /// </summary>
        /// <param name="texture">The scaling factor to be used.</param>
        public TexturePainter(string texture, float scaling)
        {
            m_texture = texture;
            m_scaling = scaling;
        }
        ...
        public override void LoadResources(D3D11.Device device)
        {
            ...
            m_painterResource = StandardResources.AddAndLoadResource<TexturePainterResource>(base.Resources, StandardResources.TexturePainterName);
        ...
        protected override void RenderInternal(RenderState renderState)
        {
            ...
            renderState.DeviceContext.OutputMerger.BlendFactor = new SlimDX.Color4(0.7f, 0.7f, 0.7f);
