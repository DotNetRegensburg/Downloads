...
namespace XmlExplorer
{
    public class MainWindowPresentationModel : IMainWindowPresentationModel
    {
        ...
        public MainWindowPresentationModel()
        {
            ...
            Open = new DelegateCommand<object>(OnOpenExecuted);
            Close = new DelegateCommand<object>(OnCloseExecuted, CanCloseExecute);
            Exit = new DelegateCommand<object>(OnExitExecuted);
        }
        ...
        public string CurrentFileName
        {
            ...
            set
            {
                ...
                // Leider notwendig, da sonst die Änderung am Command-Status 
                // nicht zum Menü propagiert wird.
